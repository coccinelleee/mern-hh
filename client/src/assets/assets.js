...
export const JobCategories = [
    ...
    "Өнімді басқару",
    "Сатылым инженериясы",
    "Техникалық жазба және құжаттама",
    "IoT әзірлеу",
...
export const manageJobsData = [
    { _id: 1, title: "Full Stack Developer", date: 1729102298497, location: "Astana", applicants: 20 },
...
export const viewApplicationsPageData = [
    { _id: 1, name: "Richard Sanford", jobTitle: "Full Stack Developer", location: "Astana", imgSrc: profile_img },
