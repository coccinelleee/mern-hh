    ...
    >
      <div className="shadow py-4">
        <div className="container px-5 2xl:px-20 mx-auto flex justify-between items-center">
          ...
          />
          {user ? (
            <div className="flex items-center gap-3 font-primary text-[20px]">
              <Link to="/applications">Қолданбалы жұмыстар</Link>
              <p>|</p>
              <p className="max-sm:hidden">
                Сәлем, {user.firstName} {user.lastName || ""}
              </p>
              <UserButton />
            </div>
          ) : (
