            ...
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-2 text-3xl font-bold tracking-tight text-[#252525] sm:text-5xl font-primary ">
                  Миллиондаған жұмыс орындары. Сізге сәйкес келетінін табыңыз.
                </p>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Интернеттегі барлық ашық позицияларды іздеңіз. Өзіңіздің жекелендірілген
                  жалақы сметасын алыңыз. Дүние жүзіндегі 600.000-нан астам
                  компания туралы пікірлерді оқыңыз.
                </p>
                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                  <div className="relative pl-9">
                    ...
                    <dd className="inline">Миллиондаған мүмкіндіктерге қол жеткізіңіз</dd>
                  </div>
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                      <svg
                    ...
                    <dd className="inline">
                      Жекелендірілген жалақы бағалауыңызды алыңыз
                    </dd>
                  </div>
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                    ...
                    <dd className="inline">
                      Компания туралы түсініктер мен шолуларды ашыңыз
                    </dd>
                  </div>
                </dl>
              </div>
