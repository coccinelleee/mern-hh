    ...
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8">
      <div className="w-full lg:w-1/4 bg-white px-4">
        {isSearched && (searchFilter.title !== "" || searchFilter.location !== "") && (
          <>
            <h3 className="font-bold text-larger mb-4 font-primary">Ағымдағы іздеу</h3>
        ...
        >
          {showFilter ? "Жабу" : "Сүзгілеу"}
        </button>

        <div className={showFilter ? "" : "hidden lg:block"}>
          <h4 className="font-semibold text-larger py-6 font-primary">Категориялар бойынша іздеу</h4>
      ...
      <section className="w-full lg:w-3/4 text-gray-800 max-lg:px-4">
        <h3 className="font-semibold text-4xl py-2 font-primary" id="job-list">
          Соңғы жұмыс орындары
        </h3>
        <p className="mb-8">Үздік компаниялардан қалаған жұмысыңызды алыңыз</p>
