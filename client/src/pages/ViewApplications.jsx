        ...
        <table className="w-full bg-white border-collapse border-gray-300 rounded-xl">
          <thead className="bg-[#f2f2f2] text-primary">
            <tr className='border-gray-300 rounded-xl'>
              ...
              <th className="py-7 px-3 sm:px-4 text-left w-[25%] text-base font-semibold">Пайдаланушы аты</th>
              <th className="py-7 px-3 sm:px-4 text-left max-sm:hidden w-[20%] text-base font-semibold">Қызмет атауы</th>
              <th className="py-7 px-3 sm:px-4 text-left max-sm:hidden w-[15%] text-base font-semibold">Орналасқан жері</th>
              <th className="py-7 px-3 sm:px-4 text-left w-[20%] text-base font-semibold">Түйіндеме</th>
              <th className="py-7 px-3 sm:px-4 text-left w-[15%] text-base font-semibold">Әрекет</th>
            </tr>
          </thead>
                ...
                .map((applicant, index) => (
                  <tr key={index} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-5 px-3 sm:px-4 border-b">
                      ...
                      >
                        Түйіндеме <img className="w-5 h-5" src={assets.resume_download_icon} alt="Download" />
                      </a>
                    </td>
