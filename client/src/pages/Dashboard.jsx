    ...
    <div className="min-h-screen bg-[#F7F7F7]">
      ...
      <div className="shadow py-4">
        <div className="px-10 flex justify-between items-center ">
          <img
            onClick={(e) => navigate("/")}
            className="w-[100px] sm:w-[170px] h-auto cursor-pointer min-w-16 md:w-33 md:min-w-33 flex-shrink-0 object-contain"
            src={logo}
            alt="Logo"
          />
        ...
        <div className="inline-block min-h-screen border-r-2 ">
          <ul className="flex flex-col items-start pt-10 text-gray-800 p-5 rounded-xl gap-3">
            ...
            >
              ...
              <p className="max-sm:hidden">Жұмыс қосу</p>
            </NavLink>
            ...
            >
              ...
              <p className="max-sm:hidden">Жұмыстарды басқару</p>
            </NavLink>
            ...
            >
              ...
              <p className="max-sm:hidden">Қолданбаларды көру</p>
            </NavLink>
          </ul>
        </div>
