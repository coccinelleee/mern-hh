...
const ManageJobs = () => {
  ...
  <div className='flex items-center justify-center h-[70vh]'>
    <p className='text-xl sm:text-2xl '>Жұмыс орындары жоқ немесе жарияланған</p>
  </div>) : (
    <motion.div
      ...
      <table className="w-full bg-[#F2F2F2] border border-gray-300 rounded-xl max-sm:text-sm text-primary">
          <thead className="bg-[#F2F2F2]">
            <tr >
              ...
              <th className="py-2 px-4 border-b text-left sm:text-[18px] font-secondary font-semibold ">Қызмет атауы</th>
              ...
              <th className="py-2 px-4 border-b text-center sm:text-[16px] font-secondary font-semibold">Өтініш берушілер</th>
              <th className="py-2  border-b text-left sm:text-[16px] font-secondary font-semibold ">Көрінетін</th>
            </tr>
          </thead>
          <tbody>
            {jobs.map((job, index) => (
